...
def main():
    ...
    parser.add_argument('MiSeq Folder', widget='DirChooser', help='MiSeqAnalysis directory.')
    parser.add_argument('Email Address', help='Email you used to sign up for FoodPort.')
